...
* **Single-File Architecture:** The entire portal (UI, styling, logic, and emulators) is contained within a single portal.html file. Just download and double-click to run.  
* **Dual-Engine Emulation:**  
...
3. At the boot screen, enter the default developer passcode: nexus.  
4. Click **\+ New Directory** to create a folder.  
5. Click **Install 1 Game** or **Bulk Install** to upload your downloaded .swf or .html files.  
